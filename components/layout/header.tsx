...
export function Header() {
  ...
  const getPageTitle = () => {
    switch (pathname) {
      ...
      default: return 'AI Career Intel';
    }
  };
  ...
  return (
    <header className="h-16 flex items-center justify-between px-4 sm:px-6 border-b border-border bg-card text-card-foreground relative z-10">
